...
// Updated API configuration with working model
...
router.post('/generate', async (req, res) => {
  try {
    ...
    console.log(`🤖 Generating ${outputType} content with Gemini AI (gemini-2.5-flash)...`);
...
router.post('/chat', async (req, res) => {
  try {
    ...
    console.log(`🤖 Generating chat response with Gemini AI (gemini-2.5-flash) for ${user?.name || 'user'}...`);
...
Assistant:`;
    ...
    console.log(`🤖 Generating chat response with Gemini AI (gemini-2.5-flash)...`);
